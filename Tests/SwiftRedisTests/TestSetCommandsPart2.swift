...
public class TestSetCommandsPart2: XCTestCase {
    ...
    let key3 = "key3"
    let key4 = "key4"
    let redisKey1 = "rediskey1"
    let redisKey2 = "rediskey2"
    let redisKey3 = "rediskey3"
    let redisKey4 = "rediskey4"
    
    let member1 = "its over 9000"
    let member2 = "What up doc?"
    let member3 = "insert reference here"
    let member4 = "insert test string here"
    let redismember1 = "redis is over 9000"
    let redismember2 = "What up doc? Just redis"
    let redismember3 = "insert reference with redis here"
    let redismember4 = "insert redisstring here"
